...
class CxCFrame(tk.Frame):
    ...
    def _build(self):
        ...
        tk.Label(top, text="Cuentas por Cobrar", font=T.FONT_LARGE,
        ...
        cols = ("ID", "Cliente", "Monto", "Saldo", "Estado", "Vencimiento")
    ...
    def _pagar(self):
        ...
        if monto:
            dao.pagar_cxc(c["id"], Decimal(str(monto)))
            self._cargar()
